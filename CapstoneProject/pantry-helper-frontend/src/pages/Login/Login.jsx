...
import { getUserSubscriptions, addPantryUser, deletePantryUser } from '../../services/pantryUserService';
...
const Login = () => {
    ...
    const handleAccessCodeSubmit = async (e) => {
        ...
        try {
          ...
          await addPantryUser(profile.profileID, res.data.pantryID, 'staff');
