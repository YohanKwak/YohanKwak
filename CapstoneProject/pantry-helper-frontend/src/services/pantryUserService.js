...
const API_URL = 'http://localhost:3001/PantryUsers';
...
export const updateUserAuthority = async (profileID, pantryID, userAuthority) => {
  return await axios.put(`${API_URL}/${profileID}/${pantryID}/authority`, { userAuthority });
};
